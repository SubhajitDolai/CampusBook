...
export default async function ResourceDetailsPage({ params }: { params: Promise<{ buildingId: string; floorId: string; resourceId: string }> }) {
  ...
  try {
    ...
    const [buildingData, floorData, resourceData, bookingsData] = await Promise.all([
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbLink href={`/buildings/${buildingId}/floors/${floorId}`}>{floor.name}</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
