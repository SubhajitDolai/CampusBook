...
export const Logo = ({ className }: { className?: string }) => {
    ...
    const src = resolvedTheme === 'dark' ? '/logo-light.webp' : '/logo-dark.webp';
    return (
        <Image
            src={src}
            alt="CampusGrid Logo"
...
export const LogoIcon2 = ({ className }: { className?: string }) => {
    const { resolvedTheme } = useTheme();
    const [mounted, setMounted] = useState(false);
    ...
    const src = resolvedTheme === 'dark' ? '/logo-light-small.webp' : '/logo-dark-small.webp';
    return (
        <Image
            src={src}
            alt="CampusGrid Logo Icon"
